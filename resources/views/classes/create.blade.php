<x-app-layout>
    ...
    <div class="mx-auto max-w-3xl">
        <form method="POST" action="{{ route('classes.store') }}" class="card grid gap-4">
            @csrf
            <div>
                <x-input-label for="class_name" value="Class name" />
                <input id="class_name" name="class_name" value="{{ old('class_name') }}" class="form-control mt-1" required>
            </div>
            <div>
