<x-app-layout>
    ...
    <div class="mx-auto max-w-5xl space-y-6">
        <div class="card space-y-2">
            ...
            <p class="text-sm text-slate-600">Class: {{ $student->schoolClass->display_name }} | Status: {{ $student->status }} | Fee: {{ $student->isFree() ? 'Free (No Tuition)' : 'Regular (Tuition Required)' }}</p>
